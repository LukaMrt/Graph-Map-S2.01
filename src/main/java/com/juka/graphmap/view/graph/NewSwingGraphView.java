...
public class NewSwingGraphView extends GlobalSwingView implements GraphView {
    ...
    @Inject
    public NewSwingGraphView(GraphMapJFrame frame, CompareUI compareUI, PathUI pathUI, DirectNeighborsUI directNeighborsUI, IndirectNeighborsUI indirectNeighborsUI, HomeUI homeUI) {
        super(frame);
