...
public class NewSwingDirectNeighborsView extends GlobalSwingView implements DirectNeighborsView {
    ...
    @Inject
    public NewSwingDirectNeighborsView(GraphMapJFrame frame, DirectNeighborsUI directNeighborsUI, GraphUI graphUI) {
        super(frame);
