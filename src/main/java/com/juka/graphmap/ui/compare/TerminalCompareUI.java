...
public class TerminalCompareUI implements CompareUI {
    ...
    @Inject
    public TerminalCompareUI(NodeCompareService nodeCompareService, GraphService graphService, NodeService nodeService, CompareView compareView, HomeUI homeUI, GraphUI graphUI) {
